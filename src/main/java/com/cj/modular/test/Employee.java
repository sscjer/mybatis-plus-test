...
public class Employee {
    ...
    public Employee() {
        System.out.println("this class name is Employee!!!");
    }

    public Employee(String name, Integer age, Double height) {
        this.name = name;
        this.age = age;
        this.height = height;
        System.out.println("Employee is " + name + "age is " + age + ",height is " + height);
    }
